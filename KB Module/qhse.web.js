////////////////////////////////////////////////////
Config.appid = "qhse";
Config.include = ["risks.web.js", "risks.js", "qhse.options.js", "qhse.steps.web.js", "qhse.roles.web.js", "qhse.revisions.web.js", "qhse.common.js",
...
function viewProcedure(id, tab) {
    ...
    if (Qhse.hasRight("edit")) Toolbar.addButton(R.EDIT, "showEditPopup({id})", "edit");
    Toolbar.addButton(R.NEWCOMMENT, "newComment({id})", "new");
    if (User.isManager()) Toolbar.addButton(R.EXPORT, "exportPdf({id})", "download");
